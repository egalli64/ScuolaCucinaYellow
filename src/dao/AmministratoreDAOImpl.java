...
public class AmministratoreDAOImpl implements AmministratoreDAO {
	...
	public void update(Utente amministratore) throws SQLException {
		...
		PreparedStatement ps = conn.prepareStatement(
				"UPDATE amministratori SET password=?, nome=?, cognome=?, dataNascita=?, email=?, telefono=? where id_amministratore=?");
	 ...
	 * eccezione Se non è cancellabile si solleva una eccezione
	 */
	@Override
